...
var fs, path, util, ejs,
    version, program, gruntMultiTask;
fs = require("fs");
path = require("path");
util = require("./util");
ejs = require("ejs");
program = require("./program");
gruntMultiTask = require("./gruntMultiTask");
...
util.extend(Zombie.prototype, {
    ...
    registerGruntMultiTask: function registerGruntMultiTask(grunt) {
        return gruntMultiTask.bind(this)(grunt);
    },
    ...
    _renderNode: function _renderNode(name, props) {
        ...
        if (layout instanceof Node) {
            return this._renderNode(node.layout, { content: nodeRendered });
        } else {
            return nodeRendered;
        }
    },
